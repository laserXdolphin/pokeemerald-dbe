...
{
    TRAINER_CLASS(PKMN_TRAINER_1, "{PKMN} TRAINER", 25),
    TRAINER_CLASS(CIPHER_ADMIN, "CIPHER ADMIN", 25),
    TRAINER_CLASS(HIKER, "HIKER", 10, ITEM_HEAVY_BALL),
    ...
    TRAINER_CLASS(BIRD_KEEPER, "BIRD KEEPER", 8, ITEM_FAST_BALL),
    ...
    TRAINER_CLASS(EXPERT, "EXPERT", 10, ITEM_ULTRA_BALL),
    TRAINER_CLASS(AQUA_ADMIN, "AQUA ADMIN", 10, ITEM_ULTRA_BALL),
    TRAINER_CLASS(BLACK_BELT, "BLACK BELT", 8, ITEM_GREAT_BALL),
    TRAINER_CLASS(AQUA_LEADER, "AQUA LEADER", 20, ITEM_MASTER_BALL),
    TRAINER_CLASS(HEX_MANIAC, "HEX MANIAC", 6, ITEM_DUSK_BALL),
    TRAINER_CLASS(AROMA_LADY, "AROMA LADY", 10, ITEM_GREAT_BALL),
    TRAINER_CLASS(RUIN_MANIAC, "RUIN MANIAC", 15, ITEM_TIMER_BALL),
    TRAINER_CLASS(INTERVIEWER, "INTERVIEWER", 12),
    TRAINER_CLASS(TUBER_F, "TUBER", 1, ITEM_DIVE_BALL),
    TRAINER_CLASS(TUBER_M, "TUBER", 1, ITEM_DIVE_BALL),
    TRAINER_CLASS(LADY, "LADY", 50, ITEM_LUXURY_BALL),
    TRAINER_CLASS(BEAUTY, "BEAUTY", 20, ITEM_LOVE_BALL),
    TRAINER_CLASS(RICH_BOY, "RICH BOY", 50, ITEM_LUXURY_BALL),
    TRAINER_CLASS(POKEMANIAC, "POKéMANIAC", 15, ITEM_PREMIER_BALL),
    TRAINER_CLASS(GUITARIST, "GUITARIST", 8, ITEM_FAST_BALL),
    TRAINER_CLASS(KINDLER, "KINDLER", 8, ITEM_GREAT_BALL),
    TRAINER_CLASS(CAMPER, "CAMPER", 4),
    TRAINER_CLASS(PICNICKER, "PICNICKER", 4),
    TRAINER_CLASS(BUG_MANIAC, "BUG MANIAC", 15, ITEM_NET_BALL),
    TRAINER_CLASS(PSYCHIC, "PSYCHIC", 6, ITEM_DREAM_BALL),
    ...
    TRAINER_CLASS(WINSTRATE, "WINSTRATE", 10, ITEM_ULTRA_BALL),
    TRAINER_CLASS(POKEFAN, "POKéFAN", 20, ITEM_LOVE_BALL),
    ...
    TRAINER_CLASS(TRIATHLETE, "TRIATHLETE", 10, ITEM_QUICK_BALL),
    TRAINER_CLASS(DRAGON_TAMER, "DRAGON TAMER", 12, ITEM_ULTRA_BALL),
    TRAINER_CLASS(NINJA_BOY, "NINJA BOY", 3, ITEM_QUICK_BALL),
    TRAINER_CLASS(BATTLE_GIRL, "BATTLE GIRL", 6, ITEM_GREAT_BALL),
    TRAINER_CLASS(PARASOL_LADY, "PARASOL LADY", 10, ITEM_GREAT_BALL),
    TRAINER_CLASS(SWIMMER_F, "SWIMMER♀", 2, ITEM_DIVE_BALL),
    TRAINER_CLASS(TWINS, "TWINS", 3),
    TRAINER_CLASS(SAILOR, "SAILOR", 8, ITEM_GREAT_BALL),
    ...
    TRAINER_CLASS(BUG_CATCHER, "BUG CATCHER", 4, ITEM_NET_BALL),
    ...
    TRAINER_CLASS(YOUNG_COUPLE, "YOUNG COUPLE", 8, ITEM_LOVE_BALL),
