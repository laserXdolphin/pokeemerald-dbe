...
{
    [TRAINER_CLASS_PKMN_TRAINER_1] = { _("{PKMN} TRAINER"), 25 },
    [TRAINER_CLASS_CIPHER_ADMIN] = { _("CIPHER ADMIN"), 25 },
    [TRAINER_CLASS_HIKER] = { _("HIKER"), 10, ITEM_HEAVY_BALL },
    ...
    [TRAINER_CLASS_BIRD_KEEPER] = { _("BIRD KEEPER"), 8, ITEM_FAST_BALL },
    ...
    [TRAINER_CLASS_EXPERT] = { _("EXPERT"), 10, ITEM_ULTRA_BALL },
    [TRAINER_CLASS_AQUA_ADMIN] = { _("AQUA ADMIN"), 10, ITEM_ULTRA_BALL },
    [TRAINER_CLASS_BLACK_BELT] = { _("BLACK BELT"), 8, BALL_GREAT },
    [TRAINER_CLASS_AQUA_LEADER] = { _("AQUA LEADER"), 20, BALL_MASTER },
    [TRAINER_CLASS_HEX_MANIAC] = { _("HEX MANIAC"), 6, ITEM_DUSK_BALL },
    [TRAINER_CLASS_AROMA_LADY] = { _("AROMA LADY"), 10, ITEM_GREAT_BALL },
    [TRAINER_CLASS_RUIN_MANIAC] = { _("RUIN MANIAC"), 15, ITEM_TIMER_BALL },
    [TRAINER_CLASS_INTERVIEWER] = { _("INTERVIEWER"), 12 },
    [TRAINER_CLASS_TUBER_F] = { _("TUBER"), 1, ITEM_DIVE_BALL },
    [TRAINER_CLASS_TUBER_M] = { _("TUBER"), 1, ITEM_DIVE_BALL },
    [TRAINER_CLASS_LADY] = { _("LADY"), 50, ITEM_LUXURY_BALL },
    [TRAINER_CLASS_BEAUTY] = { _("BEAUTY"), 20, ITEM_LOVE_BALL },
    [TRAINER_CLASS_RICH_BOY] = { _("RICH BOY"), 50, ITEM_LUXURY_BALL },
    [TRAINER_CLASS_POKEMANIAC] = { _("POKéMANIAC"), 15, ITEM_PREMIER_BALL },
    [TRAINER_CLASS_GUITARIST] = { _("GUITARIST"), 8, ITEM_FAST_BALL },
    [TRAINER_CLASS_KINDLER] = { _("KINDLER"), 8, ITEM_GREAT_BALL },
    [TRAINER_CLASS_CAMPER] = { _("CAMPER"), 4 },
    [TRAINER_CLASS_PICNICKER] = { _("PICNICKER"), 4 },
    [TRAINER_CLASS_BUG_MANIAC] = { _("BUG MANIAC"), 15, ITEM_NET_BALL },
    [TRAINER_CLASS_PSYCHIC] = { _("PSYCHIC"), 6, ITEM_DREAM_BALL },
    [TRAINER_CLASS_GENTLEMAN] = { _("GENTLEMAN"), 20, BALL_LUXURY },
    [TRAINER_CLASS_ELITE_FOUR] = { _("ELITE FOUR"), 25, BALL_ULTRA },
    [TRAINER_CLASS_LEADER] = { _("LEADER"), 25, ITEM_ULTRA_BALL },
    [TRAINER_CLASS_SCHOOL_KID] = { _("SCHOOL KID") },
    [TRAINER_CLASS_SR_AND_JR] = { _("SR. AND JR."), 4 },
    [TRAINER_CLASS_WINSTRATE] = { _("WINSTRATE"), 10, ITEM_ULTRA_BALL },
    [TRAINER_CLASS_POKEFAN] = { _("POKéFAN"), 20, ITEM_LOVE_BALL },
    [TRAINER_CLASS_YOUNGSTER] = { _("YOUNGSTER"), 4 },
    [TRAINER_CLASS_CHAMPION] = { _("CHAMPION"), 50, ITEM_ULTRA_BALL },
    [TRAINER_CLASS_FISHERMAN] = { _("FISHERMAN"), 10, B_TRAINER_CLASS_POKE_BALLS >= GEN_8 ? BALL_DIVE : BALL_LURE },
    [TRAINER_CLASS_TRIATHLETE] = { _("TRIATHLETE"), 10, ITEM_QUICK_BALL },
    [TRAINER_CLASS_DRAGON_TAMER] = { _("DRAGON TAMER"), 12, ITEM_ULTRA_BALL },
    [TRAINER_CLASS_NINJA_BOY] = { _("NINJA BOY"), 3, ITEM_QUICK_BALL },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("BATTLE GIRL"), 6, ITEM_GREAT_BALL },
    [TRAINER_CLASS_PARASOL_LADY] = { _("PARASOL LADY"), 10, ITEM_GREAT_BALL },
    [TRAINER_CLASS_SWIMMER_F] = { _("SWIMMER♀"), 2, BALL_DIVE },
    [TRAINER_CLASS_TWINS] = { _("TWINS"), 3 },
    [TRAINER_CLASS_SAILOR] = { _("SAILOR"), 8, ITEM_GREAT_BALL },
    [TRAINER_CLASS_COOLTRAINER_2] = { _("COOLTRAINER"), 5, BALL_ULTRA },
    [TRAINER_CLASS_MAGMA_ADMIN] = { _("MAGMA ADMIN"), 10, ITEM_ULTRA_BALL },
    [TRAINER_CLASS_RIVAL] = { _("{PKMN} TRAINER"), 15 },
    [TRAINER_CLASS_BUG_CATCHER] = { _("BUG CATCHER"), 4, ITEM_NET_BALL },
    [TRAINER_CLASS_PKMN_RANGER] = { _("{PKMN} RANGER"), 12, ITEM_SAFARI_BALL },
    [TRAINER_CLASS_MAGMA_LEADER] = { _("MAGMA LEADER"), 20, BALL_MASTER },
    [TRAINER_CLASS_LASS] = { _("LASS"), 4 },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("YOUNG COUPLE"), 8, ITEM_LOVE_BALL },
