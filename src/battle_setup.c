...
const struct RematchTrainer gRematchTable[REMATCH_TABLE_ENTRIES] =
{
    ...
    [REMATCH_SIDNEY] = REMATCH(TRAINER_SIDNEY_1, TRAINER_SIDNEY_1, TRAINER_SIDNEY_1, TRAINER_SIDNEY_1, TRAINER_SIDNEY_1, EVER_GRANDE_CITY),
    [REMATCH_PHOEBE] = REMATCH(TRAINER_PHOEBE_1, TRAINER_PHOEBE_1, TRAINER_PHOEBE_1, TRAINER_PHOEBE_1, TRAINER_PHOEBE_1, EVER_GRANDE_CITY),
    [REMATCH_GLACIA] = REMATCH(TRAINER_GLACIA_1, TRAINER_GLACIA_1, TRAINER_GLACIA_1, TRAINER_GLACIA_1, TRAINER_GLACIA_1, EVER_GRANDE_CITY),
    [REMATCH_DRAKE] = REMATCH(TRAINER_DRAKE_1, TRAINER_DRAKE_1, TRAINER_DRAKE_1, TRAINER_DRAKE_1, TRAINER_DRAKE_1, EVER_GRANDE_CITY),
    [REMATCH_WALLACE] = REMATCH(TRAINER_WALLACE_1, TRAINER_WALLACE_1, TRAINER_WALLACE_1, TRAINER_WALLACE_1, TRAINER_WALLACE_1, EVER_GRANDE_CITY),
};
...
static bool32 UpdateRandomTrainerRematches(const struct RematchTrainer *table, u16 mapGroup, u16 mapNum)
{
    ...
    s32 i = Random() % REMATCH_SPECIAL_TRAINER_START;
