...
const u8 gText_SeismicToss24BP[] = _("EXPAND. FORCE{CLEAR_TO 0x4E}24BP");
const u8 gText_DreamEater24BP[] = _("RISINGVOLTAGE{CLEAR_TO 0x4E}24BP");
const u8 gText_MegaPunch24BP[] = _("SCORCH. SANDS{CLEAR_TO 0x4E}24BP");
