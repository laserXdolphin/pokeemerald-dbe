...
const u8 gText_BlueFlute[] = _("WIDE LENS");
const u8 gText_YellowFlute[] = _("ZOOM LENS");
const u8 gText_RedFlute[] = _("SCOPE LENS");
const u8 gText_WhiteFlute[] = _("WISE GLASSES");
const u8 gText_BlackFlute[] = _("METRONOM");
const u8 gText_PrettyChair[] = _("CLEAR AMULET");
const u8 gText_PrettyDesk[] = _("LIGHT CLAY");
...
const u8 gText_Softboiled16BP[] = _("GRASSY GLIDE{CLEAR_TO 0x4E}16BP");
const u8 gText_SeismicToss24BP[] = _("EXPANDING FORCE{CLEAR_TO 0x4E}24BP");
const u8 gText_DreamEater24BP[] = _("RISING VOLTAGE{CLEAR_TO 0x4E}24BP");
const u8 gText_MegaPunch24BP[] = _("SCORCHING SANDS{CLEAR_TO 0x4E}24BP");
const u8 gText_MegaKick48BP[] = _("PSYCHIC NOISE{CLEAR_TO 0x4E}48BP");
const u8 gText_BodySlam48BP[] = _("BODY SLAM{CLEAR_TO 0x4E}48BP");
const u8 gText_RockSlide48BP[] = _("ROCK SLIDE{CLEAR_TO 0x4E}48BP");
const u8 gText_Counter48BP[] = _("TRAILBLAZE{CLEAR_TO 0x4E}48BP");
...
const u8 gText_DefenseCurl16BP[] = _("ICE FANG{CLEAR_TO 0x4E}16BP");
const u8 gText_Snore24BP[] = _("THUNDER FANG{CLEAR_TO 0x4E}24BP");
const u8 gText_MudSlap24BP[] = _("FIRE FANG{CLEAR_TO 0x4E}24BP");
const u8 gText_Swift24BP[] = _("PSYCHIC FANGS{CLEAR_TO 0x4E}24BP");
const u8 gText_IcyWind24BP[] = _("ICY WIND{CLEAR_TO 0x4E}24BP");
const u8 gText_Endure48BP[] = _("IRON HEAD{CLEAR_TO 0x4E}48BP");
const u8 gText_PsychUp48BP[] = _("POISON JAB{CLEAR_TO 0x4E}48BP");
